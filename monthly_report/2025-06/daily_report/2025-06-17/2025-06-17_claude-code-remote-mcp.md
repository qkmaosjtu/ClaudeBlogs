...
- 原文链接：https://claude.com/blog/claude-code-remote-mcp
- 发布日期：2025-06-17
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Platform
- 关键词：Claude Code, MCP, API, context, data

## 整体摘要

这篇文章聚焦于 Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Connect your favorite development tools and data sources securely to Claude Code through remote MCP servers. Today, we’re announcing support for remote MCP servers in Claude Code. 从正文结构看，文章围绕 Using Claude Code as your primary development interface、Seamless connections with minimal maintenance、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- Connect your favorite development tools and data sources securely to Claude Code through remote MCP servers. Today, we’re announcing support for remote MCP servers in Claude Code.
- 正文重点章节：Using Claude Code as your primary development interface
- 正文重点章节：Seamless connections with minimal maintenance
