...
- 原文链接：https://claude.com/blog/introducing-citations-api
- 发布日期：2025-06-22
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude apps
- 关键词：agent, API, context, legal, citations

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Claude can now cite specific passages from your documents, delivering verifiable responses with built-in source tracking. Update: Now available in Amazon Bedrock. (June 30, 2025) Today, we&#39;re launching Citations, a new API feature that lets Claude ground its answers in source documents. 从正文结构看，文章围绕 Trust by verification、Use cases、How it works、Pricing 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
