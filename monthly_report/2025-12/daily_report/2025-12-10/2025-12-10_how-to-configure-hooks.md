...
- 分类：Claude Code
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, hooks, subagents, context, security, workflow, enterprise

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Learn how to configure Claude Code hooks to automate repetitive tasks, enforce project rules, and inject dynamic context into your coding sessions.  从正文结构看，文章围绕 What is a hook?、Why use hooks in Claude Code?、Claude Code hook types and when to use them、PreToolUse 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：What is a hook?
- 正文重点章节：Why use hooks in Claude Code?
- 正文重点章节：Claude Code hook types and when to use them
- 正文重点章节：PreToolUse
