...
- 分类：Agents
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, skills, API, context, compliance, workflow, enterprise

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Learn how Agent Skills package domain expertise for AI agents—turning capable generalists into knowledgeable specialists through organized files and workflows. 从正文结构看，文章围绕 The new paradigm: code is all you need、The missing piece: domain expertise、What are Agent Skills?、Progressive disclosure 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：The new paradigm: code is all you need
- 正文重点章节：The missing piece: domain expertise
- 正文重点章节：What are Agent Skills?
- 正文重点章节：Progressive disclosure
