...
- 原文标题：Your favorite work tools are now interactive connectors inside Claude
- 原文链接：https://claude.com/blog/interactive-tools-in-claude
- 发布日期：2026-01-25
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude apps
- 关键词：agent, MCP, context, connectors, enterprise, data, sales, citations

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：MCP Apps bring interactive connectors to Claude. Interact with connectors with a live UI right in your conversation — no tab-switching required. 从正文结构看，文章围绕 MCP Apps: Built on an open standard ‍、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- MCP Apps bring interactive connectors to Claude. Interact with connectors with a live UI right in your conversation — no tab-switching required.
- 正文重点章节：MCP Apps: Built on an open standard ‍
