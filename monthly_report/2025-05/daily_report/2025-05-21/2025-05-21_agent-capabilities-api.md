...
- 原文标题：New capabilities for building agents on the Anthropic API
- 原文链接：https://claude.com/blog/agent-capabilities-api
- 发布日期：2025-05-21
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Platform
- 关键词：agent, agents, MCP, API, context, workflow, data, sales, web search, prompt caching

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Claude now offers code execution, MCP server connections, file storage, and extended prompt caching through the API—giving developers powerful tools to build agents that analyze data, connect to external systems, and maintain context for longer periods of time. 从正文结构看，文章围绕 Building better AI agents、Code execution tool、MCP connector、Files API 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Building better AI agents
- 正文重点章节：Code execution tool
- 正文重点章节：MCP connector
- 正文重点章节：Files API
