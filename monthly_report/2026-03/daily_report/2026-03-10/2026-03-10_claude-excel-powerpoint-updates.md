...
- 原文标题：Advancing Claude for Excel and PowerPoint
- 原文链接：https://claude.com/blog/claude-excel-powerpoint-updates
- 发布日期：2026-03-10
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude Enterprise
- 关键词：agent, MCP, skills, context, compliance, connectors, workflow, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Claude for Excel and PowerPoint now share full context across open files, and skills make any workflow instantly repeatable. 从正文结构看，文章围绕 One conversation across Excel and PowerPoint、Turn best practices into one-click actions with skills、Deployment flexibility、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：One conversation across Excel and PowerPoint
- 正文重点章节：Turn best practices into one-click actions with skills
- 正文重点章节：Deployment flexibility
