...
- 原文标题：Improving skill-creator: Test, measure, and refine Agent Skills
- 原文链接：https://claude.com/blog/improving-skill-creator-test-measure-and-refine-agent-skills
- 发布日期：2026-03-02
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Claude Code
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, skills, context, workflow, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Skill authors now have tools to verify their skills work, catch regressions, and improve descriptions—no coding required. 从正文结构看，文章围绕 Two kinds of skills、Using evals to test and improve skills、Faster, more consistent evaluation with multi-agent support、Getting skills to trigger at the right time 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Two kinds of skills
- 正文重点章节：Using evals to test and improve skills
- 正文重点章节：Faster, more consistent evaluation with multi-agent support
- 正文重点章节：Getting skills to trigger at the right time
