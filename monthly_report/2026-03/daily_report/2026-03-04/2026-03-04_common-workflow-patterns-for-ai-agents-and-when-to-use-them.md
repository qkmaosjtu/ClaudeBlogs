...
- 分类：Agents
- 产品：Claude Platform
- 关键词：agent, agents, API, context, security, compliance, workflow, data, marketing

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Practical guidance on how to structure agent tasks using three common workflow patterns, with tradeoffs and benefits for each. 从正文结构看，文章围绕 How workflows and agents work together、Understanding workflows vs. autonomous agents、Agent workflow patterns、Sequential workflows 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：How workflows and agents work together
- 正文重点章节：Understanding workflows vs. autonomous agents
- 正文重点章节：Agent workflow patterns
- 正文重点章节：Sequential workflows
