...
- 分类：Claude Code
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, subagents, API, context, security, workflow, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Learn how to use CLAUDE.md files to give Claude Code persistent context about your project structure, coding standards, and workflows. 从正文结构看，文章围绕 What is a CLAUDE.md file?、Getting started with /init、How to structure your CLAUDE.md、Give Claude a map 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：What is a CLAUDE.md file?
- 正文重点章节：Getting started with /init
- 正文重点章节：How to structure your CLAUDE.md
- 正文重点章节：Give Claude a map
