...
- 分类：Agents
- 产品：Claude apps
- 关键词：agent, agents, Claude Code, MCP, skills, subagents, API, context, security, compliance

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Skills are an increasingly powerful tool for creating custom AI workflows and agents, but where do they fit in the Claude stack? We explain what tool to use when - and how they all work together. 从正文结构看，文章围绕 Understanding your agentic building blocks、What are Skills?、What are prompts?、What are Projects? 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Understanding your agentic building blocks
- 正文重点章节：What are Skills?
- 正文重点章节：What are prompts?
- 正文重点章节：What are Projects?
