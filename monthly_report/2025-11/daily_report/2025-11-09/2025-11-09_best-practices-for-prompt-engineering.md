...
- 原文标题：Best practices for prompt engineering
- 原文链接：https://claude.com/blog/best-practices-for-prompt-engineering
- 发布日期：2025-11-09
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Agents
- 产品：Claude apps
- 关键词：agent, skills, API, context, workflow, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Master the art of prompt engineering with Claude. 从正文结构看，文章围绕 How to use prompt engineering、Core techniques、Be explicit and clear、Provide context and motivation 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- Master the art of prompt engineering with Claude.
- 正文重点章节：How to use prompt engineering
- 正文重点章节：Core techniques
- 正文重点章节：Be explicit and clear
- 正文重点章节：Provide context and motivation
