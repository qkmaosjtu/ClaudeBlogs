...
- 原文标题：Prompt caching with Claude
- 原文链接：https://claude.com/blog/prompt-caching
- 发布日期：2025-08-13
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Platform
- 关键词：agent, agents, API, context, prompt caching

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Claude caches frequently used context between API calls, reducing costs and latency for long prompts. Update : Prompt caching is Generally Available on the Anthropic API. Prompt caching is also available in preview in Amazon Bedrock and on Google Cloud’s Vertex AI. 从正文结构看，文章围绕 When to use prompt caching、How we price cached prompts、Customer spotlight: Notion、Get started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：When to use prompt caching
- 正文重点章节：How we price cached prompts
- 正文重点章节：Customer spotlight: Notion
- 正文重点章节：Get started
