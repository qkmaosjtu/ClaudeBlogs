...
- 原文链接：https://claude.com/blog/1m-context
- 发布日期：2025-08-11
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude apps
- 关键词：agent, agents, API, context, 1M, workflow, data, legal, browser, prompt caching

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Claude Sonnet 4 now supports up to 1 million tokens of context—a 5x increase that lets you process entire codebases, synthesize extensive document sets, and build agents that maintain coherence across hundreds of tool calls. 从正文结构看，文章围绕 Longer context, more use cases、API pricing、Customer spotlight: Bolt.new、Customer spotlight: iGent AI 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Longer context, more use cases
- 正文重点章节：API pricing
- 正文重点章节：Customer spotlight: Bolt.new
- 正文重点章节：Customer spotlight: iGent AI
