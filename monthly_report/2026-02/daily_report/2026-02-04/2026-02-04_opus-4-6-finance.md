...
- 原文链接：https://claude.com/blog/opus-4-6-finance
- 发布日期：2026-02-04
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude apps
- 关键词：agent, agents, skills, API, connectors, workflow, enterprise, data, finance, structured outputs

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：With Claude Opus 4.6, finance teams get better reasoning on complex analyses, cleaner first-pass deliverables, and new tools built for where analysts actually spend their time. 从正文结构看，文章围绕 Research, analyze, create、Better multitasking and first drafts、Go deeper without leaving your spreadsheet、Refine your presentations directly with Claude 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Research, analyze, create
- 正文重点章节：Better multitasking and first drafts
- 正文重点章节：Go deeper without leaving your spreadsheet
- 正文重点章节：Refine your presentations directly with Claude
