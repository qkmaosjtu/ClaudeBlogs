...
- 原文标题：Cowork and plugins for teams across the enterprise
- 原文链接：https://claude.com/blog/cowork-plugins-across-enterprise
- 发布日期：2026-02-23
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Agents
- 产品：Claude Enterprise
- 关键词：agent, agents, MCP, skills, context, connectors, workflow, enterprise, data, finance

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：We&#39;re introducing Cowork and plugin updates that let enterprises customize Claude to how you work. Plugins turn Claude into specialized agents for every role and department. Now, you can build private marketplaces to distribute them across your organization. 从正文结构看，文章围绕 Upgrading the plugin experience、New connectors and plugins、Working across apps、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Upgrading the plugin experience
- 正文重点章节：New connectors and plugins
- 正文重点章节：Working across apps
