...
- 原文标题：Cowork and plugins for finance 
- 原文链接：https://claude.com/blog/cowork-plugins-finance
- 发布日期：2026-02-23
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude Enterprise
- 关键词：MCP, skills, API, context, connectors, workflow, enterprise, data, finance

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：New plugins built for how finance actually works, plus cross-app workflows that move with you from Excel to PowerPoint to final deliverable. 从正文结构看，文章围绕 From data to deliverable、New finance plugins、Partner-led connectors and plugins、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：From data to deliverable
- 正文重点章节：New finance plugins
- 正文重点章节：Partner-led connectors and plugins
