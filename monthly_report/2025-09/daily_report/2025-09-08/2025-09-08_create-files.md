...
- 原文链接：https://claude.com/blog/create-files
- 发布日期：2025-09-08
...
这篇文章聚焦于 知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Describe what you need and get back ready-to-use spreadsheets, documents, presentations, and PDFs instead of just text responses. Update: Now generally available for paid plans with net network and egress controls (October 21, 2025). 从正文结构看，文章围绕 What you can do、How it works: Claude’s computer、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：What you can do
- 正文重点章节：How it works: Claude’s computer
