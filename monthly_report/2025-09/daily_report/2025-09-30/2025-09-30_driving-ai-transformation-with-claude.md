...
- 原文标题：How enterprises are driving AI transformation with Claude
- 原文链接：https://claude.com/blog/driving-ai-transformation-with-claude
- 发布日期：2025-09-30
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude Enterprise
- 关键词：agent, agents, Claude Code, skills, API, security, compliance, workflow, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：As the leader in enterprise AI, Anthropic builds state-of-the-art models specializing in industries where precision matters, from coding and cybersecurity to financial services. Claude Sonnet 4. 从正文结构看，文章围绕 How Novo Nordisk drives breakthrough drug development、How Cox Automotive personalizes the car-buying experience、Palo Alto Networks accelerates secure software development、Salesforce powers autonomous AI agents 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：How Novo Nordisk drives breakthrough drug development
- 正文重点章节：How Cox Automotive personalizes the car-buying experience
- 正文重点章节：Palo Alto Networks accelerates secure software development
- 正文重点章节：Salesforce powers autonomous AI agents
