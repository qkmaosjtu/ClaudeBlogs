...
- 原文标题：Building agents with the Claude Agent SDK
- 原文链接：https://claude.com/blog/building-agents-with-the-claude-agent-sdk
- 发布日期：2025-09-28
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Claude Code
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, subagents, API, context, workflow, data, finance

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：How to get started with the Claude Agent SDK and best practices for using it. 从正文结构看，文章围绕 Giving Claude a computer、Creating new types of agents、Building your agent loop、Gather context 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Giving Claude a computer
- 正文重点章节：Creating new types of agents
- 正文重点章节：Building your agent loop
- 正文重点章节：Gather context
