...
- 分类：Claude Code
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, skills, hooks, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程。官方摘要指出：What we learned building and scaling hundreds of skills internally at Anthropic. 从正文结构看，文章围绕 What are skills? 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
