...
- 原文标题：Observability for developers building connectors
...
- 产品：Claude apps
- 关键词：Claude Code, MCP, context, connectors, enterprise

## 整体摘要

这篇文章聚焦于 Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、模型能力与上下文。官方摘要指出：Monitor connector performance across Claude, diagnose errors and latency, and submit your MCP server to the directory in-app. Public beta now live. 从正文结构看，文章围绕 Monitor, debug, and improve connectors、Joining the directory 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Monitor, debug, and improve connectors
- 正文重点章节：Joining the directory
