...
- 原文标题：Claude Security is now in public beta
- 原文链接：https://claude.com/blog/claude-security-public-beta
- 发布日期：2026-04-29
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Security
- 关键词：agent, Claude Code, hooks, API, context, security, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Scan code for vulnerabilities and generate proposed fixes with Opus 4.7, on the Claude Platform, or through technology and services partners building with Claude. 从正文结构看，文章围绕 How Claude Security works、What we've learned since our initial preview 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：How Claude Security works
- 正文重点章节：What we've learned since our initial preview
