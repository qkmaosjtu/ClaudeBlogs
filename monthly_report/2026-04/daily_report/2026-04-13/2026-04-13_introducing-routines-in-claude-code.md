...
- 原文标题：Introducing routines in Claude Code
- 原文链接：https://claude.com/blog/introducing-routines-in-claude-code
- 发布日期：2026-04-13
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Code
- 关键词：Claude Code, MCP, hooks, API, context, security, connectors, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、模型能力与上下文。官方摘要指出：Define repeatable routines that work your backlog, review your PRs, and respond to events in the cloud. 从正文结构看，文章围绕 How it works、Scheduled routines、API routines、Webhook routines, starting with GitHub 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：How it works
- 正文重点章节：Scheduled routines
- 正文重点章节：API routines
- 正文重点章节：Webhook routines, starting with GitHub
