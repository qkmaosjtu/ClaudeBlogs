...
- 产品：Claude Platform
- 关键词：agent, agents, API, context

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、模型能力与上下文。官方摘要指出：Pair Opus as an advisor with Sonnet or Haiku as an executor, and get Opus-level intelligence in your agents at a fraction of the cost. 从正文结构看，文章围绕 Build cost-effective agents with the advisor strategy、The advisor tool 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Build cost-effective agents with the advisor strategy
- 正文重点章节：The advisor tool
