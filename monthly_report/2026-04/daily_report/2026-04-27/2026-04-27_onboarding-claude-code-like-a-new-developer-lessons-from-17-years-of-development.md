...
- 分类：Claude Code
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, skills, context, data, browser

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、模型能力与上下文。官方摘要指出：The methodology that onboards new developers to MacCoss Lab&#39;s 700,000-line codebase works on Claude Code, too. Here&#39;s how Brendan MacLean, a Claude Developer Ambassador whose lab is part of our Claude for Open Source program, did it. 从正文结构看，文章围绕 The same onboarding problem, a different kind of developer、Reducing tech debt and accelerating development、Advice for developers working on legacy codebases、Seventeen years of onboarding, one conclusion 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：The same onboarding problem, a different kind of developer
- 正文重点章节：Reducing tech debt and accelerating development
- 正文重点章节：Advice for developers working on legacy codebases
- 正文重点章节：Seventeen years of onboarding, one conclusion
