...
- 原文标题：How Carta Healthcare gets AI to reason like a clinical abstractor
- 原文链接：https://claude.com/blog/carta-healthcare-clinical-abstractor
- 发布日期：2026-04-07
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude Platform
- 关键词：context, data, healthcare

## 整体摘要

这篇文章聚焦于 企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：How Carta Healthcare used Claude and context engineering to build Lighthouse, a clinical abstraction platform reaching 99% accuracy across 22,000 cases a year. 从正文结构看，文章围绕 From rules-based extraction to clinical reasoning 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：From rules-based extraction to clinical reasoning
