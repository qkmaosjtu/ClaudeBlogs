...
- 产品：Claude Platform
- 关键词：agent, agents, Managed Agents, API, context, workflow, enterprise, finance, legal, sales

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Introducing Claude Managed Agents, a suite of composable APIs for building and deploying cloud-hosted agents at scale. 从正文结构看，文章围绕 Build and deploy agents 10x faster、Designed to make the most of Claude、What teams are building 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Build and deploy agents 10x faster
- 正文重点章节：Designed to make the most of Claude
