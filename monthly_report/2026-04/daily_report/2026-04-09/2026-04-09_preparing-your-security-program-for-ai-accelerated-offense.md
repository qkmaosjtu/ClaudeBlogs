...
- 关键词：agent, API, security, workflow, enterprise, data, browser

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：We share our initial set of recommendations to shore up your defenses based on our own findings and security practices. 从正文结构看，文章围绕 What to do now、1. Close your patch gap、2. Prepare to handle a much higher volume of vulnerability reports、3. Find bugs before you ship them 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：What to do now
- 正文重点章节：1. Close your patch gap
- 正文重点章节：2. Prepare to handle a much higher volume of vulnerability reports
- 正文重点章节：3. Find bugs before you ship them
