...
- 原文标题：Build and share AI-powered apps with Claude
- 原文链接：https://claude.com/blog/claude-powered-artifacts
- 发布日期：2025-07-24
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude apps
- 关键词：agent, API, workflow, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、知识工作与办公生产力。官方摘要指出：Build and share AI-powered apps directly in Claude. ‍ Update: Now available on Team and Enterprise plans. (July 31, 2025) Update: Upload PDFs, images, and more into your artifact. 从正文结构看，文章围绕 Build and host Claude-powered apps、Community ideas、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Build and host Claude-powered apps
- 正文重点章节：Community ideas
