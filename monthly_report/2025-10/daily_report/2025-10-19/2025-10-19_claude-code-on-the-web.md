...
- 原文链接：https://claude.com/blog/claude-code-on-the-web
- 发布日期：2025-10-19
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Code
- 关键词：Claude Code, security, workflow, enterprise, browser

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、企业治理与安全、知识工作与办公生产力。官方摘要指出：Today, we&#39;re introducing Claude Code on the web, a new way to delegate coding tasks directly from your browser. Now in beta as a research preview, you can assign multiple coding tasks to Claude that run on Anthropic-managed cloud infrastructure, perfect for tackling bug backlogs, routine fixes, or... 从正文结构看，文章围绕 Run coding tasks in parallel、Flexible for every workflow、Security-first cloud execution、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- Today, we&#39;re introducing Claude Code on the web, a new way to delegate coding tasks directly from your browser. Now in beta as a research preview, you can assign multiple coding tasks to Claude that run on Anthropic-managed cloud infrastructure, perfect for tackling bug backlogs, routine fixes, or...
- 正文重点章节：Run coding tasks in parallel
- 正文重点章节：Flexible for every workflow
- 正文重点章节：Security-first cloud execution
