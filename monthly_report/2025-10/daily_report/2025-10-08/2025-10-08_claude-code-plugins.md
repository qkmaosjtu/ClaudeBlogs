...
- 原文标题：Customize Claude Code with plugins
- 原文链接：https://claude.com/blog/claude-code-plugins
- 发布日期：2025-10-08
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, MCP, hooks, subagents, context, security, workflow, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Claude Code now supports plugins: custom collections of slash commands, agents, MCP servers, and hooks that install with a single command. Share your Claude Code setup with plugins Slash commands, agents, MCP servers, and hooks are all extension points you can use to customize your experience with... 从正文结构看，文章围绕 Share your Claude Code setup with plugins、Use cases、Plugin marketplaces、Discover new marketplaces 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Share your Claude Code setup with plugins
- 正文重点章节：Use cases
- 正文重点章节：Plugin marketplaces
- 正文重点章节：Discover new marketplaces
