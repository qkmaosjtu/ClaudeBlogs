...
- 原文标题：Building AI agents for financial services
- 原文链接：https://claude.com/blog/building-ai-agents-in-financial-services
- 发布日期：2025-10-29
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Agents
- 产品：Claude Platform
- 关键词：agent, agents, MCP, API, context, security, compliance, connectors, workflow, enterprise

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：Financial institutions are deploying autonomous AI systems to improve operations while navigating regulatory complexity and risk. Here&#39;s how. ‍ In financial services, AI agents are moving beyond pilot programs to deliver concrete business value. 从正文结构看，文章围绕 Moving beyond analysis: how agents change the game、Real-world results AI agents in finance、Transforming customer interactions、Combating fraud and financial crime 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- Financial institutions are deploying autonomous AI systems to improve operations while navigating regulatory complexity and risk. Here&#39;s how. ‍ In financial services, AI agents are moving beyond pilot programs to deliver concrete business value.
- 正文重点章节：Moving beyond analysis: how agents change the game
- 正文重点章节：Real-world results AI agents in finance
- 正文重点章节：Transforming customer interactions
- 正文重点章节：Combating fraud and financial crime
