...
- 原文标题：Agent view in Claude Code
- 原文链接：https://claude.com/blog/agent-view-in-claude-code
- 发布日期：2026-05-10
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, API, enterprise

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力。官方摘要指出：Today we&#39;re introducing agent view in Claude Code: one place to manage all your Claude Code sessions.  从正文结构看，文章围绕 How it works、See everything at once、Peek and reply without leaving、Background anything 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：How it works
- 正文重点章节：See everything at once
- 正文重点章节：Peek and reply without leaving
- 正文重点章节：Background anything
- Today we're introducing agent view in Claude Code: one place to manage all your Claude Code sessions.
