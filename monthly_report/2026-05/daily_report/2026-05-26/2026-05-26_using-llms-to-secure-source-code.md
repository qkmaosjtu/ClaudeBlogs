...
- 分类：Enterprise AI
- 产品：未标注
- 关键词：agent, agents, Claude Code, skills, API, context, security, workflow, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：We share best practices for how you can work with Claude Opus to build a threat model, discover vulnerabilities in your codebase, then verify, triage, and patch them. 从正文结构看，文章围绕 The find-and-fix loop、1. Threat model: Define what counts as a vulnerability、2. Sandbox: Run agents safely and verify exploitability、3. Discovery: Provide rich context, shorter prompts, and useful tools 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：The find-and-fix loop
- 正文重点章节：1. Threat model: Define what counts as a vulnerability
- 正文重点章节：2. Sandbox: Run agents safely and verify exploitability
- 正文重点章节：3. Discovery: Provide rich context, shorter prompts, and useful tools
