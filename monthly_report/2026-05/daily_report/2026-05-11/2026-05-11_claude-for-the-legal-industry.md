...
- 原文标题：Claude for the legal industry
- 原文链接：https://claude.com/blog/claude-for-the-legal-industry
- 发布日期：2026-05-11
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Product announcements
- 产品：Claude Cowork
- 关键词：agent, agents, Claude Code, Managed Agents, MCP, skills, context, 1M, security, compliance

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、行业落地、模型能力与上下文。官方摘要指出：We&#39;re releasing 20+ new MCP connectors that link Claude to the software that the legal industry runs on and 12 new plugins tailored specific legal work and practice areas.  从正文结构看，文章围绕 Claude works where legal teams work、New connectors across the legal stack、Practice-area plugins、Democratizing access to legal services with AI 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Claude works where legal teams work
- 正文重点章节：New connectors across the legal stack
- 正文重点章节：Practice-area plugins
- 正文重点章节：Democratizing access to legal services with AI
