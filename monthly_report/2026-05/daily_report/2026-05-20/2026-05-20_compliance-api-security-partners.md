...
- 原文标题：Claude now works with more security and compliance tools
- 原文链接：https://claude.com/blog/compliance-api-security-partners
- 发布日期：2026-05-20
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude Enterprise
- 关键词：API, security, compliance, workflow, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力。官方摘要指出：Today we&#39;re introducing integrations with notable security and compliance tools. Now IT and security teams can govern Claude across our platform and suite of products, the same way they govern other applications in their stack. 从正文结构看，文章围绕 How it works、Claude Compliance API integrations、Getting started 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：How it works
- 正文重点章节：Claude Compliance API integrations
- 正文重点章节：Getting started
- Update : We've expanded to over 60 top security and compliance partner integrations, see the full list in our Help Center .
