...
- 原文标题：How our partners are putting Opus to work for cybersecurity
- 原文链接：https://claude.com/blog/how-our-partners-are-putting-opus-to-work-for-cybersecurity
- 发布日期：2026-05-20
- 检测/生成时间：2026-06-13T12:17:15.239Z
- 分类：Enterprise AI
- 产品：Claude Security
- 关键词：agent, agents, API, context, security, workflow, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、企业治理与安全、知识工作与办公生产力、模型能力与上下文。官方摘要指出：Learn how companies like Wiz, Palo Alto Networks, and Accenture are using Claude Opus to find and fix vulnerabilities faster and deploy AI defense at scale. 从正文结构看，文章围绕 Early results、Continuous offensive testing at production scale、Closing the gap between finding and fixing、Getting AI into production, governed 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Early results
- 正文重点章节：Continuous offensive testing at production scale
- 正文重点章节：Closing the gap between finding and fixing
- 正文重点章节：Getting AI into production, governed
