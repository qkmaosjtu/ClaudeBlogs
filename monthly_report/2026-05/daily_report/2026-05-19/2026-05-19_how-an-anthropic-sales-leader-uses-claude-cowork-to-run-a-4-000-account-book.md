...
- 原文标题：How an Anthropic sales leader uses Claude Cowork to run a 4,000-account book
...
- 分类：Enterprise AI
- 产品：Claude Cowork
- 关键词：agent, Claude Code, skills, API, enterprise, data, healthcare, sales, marketing

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、知识工作与办公生产力、行业落地。官方摘要指出：Travis Bryant, Head of US Mid-Market GTM at Anthropic, shares how he uses Claude Cowork to prepare customer briefs and weekly forecasts, and to run an overnight territory scoring that used to take cross-functional teams hundreds of hours. 从正文结构看，文章围绕 What I run in Claude Cowork every day, week, and quarter、Why Claude Cowork works for me、Where sales teams should start 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：What I run in Claude Cowork every day, week, and quarter
- 正文重点章节：Why Claude Cowork works for me
- 正文重点章节：Where sales teams should start
