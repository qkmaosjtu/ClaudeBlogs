...
- 产品：Claude Platform
- 关键词：agent, agents, Managed Agents, MCP, API, context, security, workflow, enterprise, data

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、平台 API 与集成能力、企业治理与安全、行业落地、模型能力与上下文。官方摘要指出：Claude Managed Agents can now operate in a sandbox you control and connect to your private Model Context Protocol (MCP) servers 从正文结构看，文章围绕 Keep agent execution within your perimeter、Choose your sandbox client、Connect to services within your private network 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
...
- 正文重点章节：Keep agent execution within your perimeter
- 正文重点章节：Choose your sandbox client
- 正文重点章节：Connect to services within your private network
