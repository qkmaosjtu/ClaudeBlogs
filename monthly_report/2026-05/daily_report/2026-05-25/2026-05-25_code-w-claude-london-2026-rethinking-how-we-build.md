...
- 原文标题：Code w/ Claude London 2026: Rethinking how we build
...
- 产品：Claude Code
- 关键词：agent, agents, Claude Code, Managed Agents, MCP, API, context, security, enterprise

## 整体摘要

这篇文章聚焦于 智能体与工作流自动化、Claude Code 与软件工程、平台 API 与集成能力、企业治理与安全、模型能力与上下文。官方摘要指出：Couldn&#39;t make it to London? Check out our Code w/ Claude London event recap and watch our session recordings.  从正文结构看，文章围绕 What was announced、In case you missed it 展开，重点不只是功能发布，而是说明这些能力如何嵌入真实工作流、开发流程或企业治理框架。
